...
+ (void) deleteAllOrderDetails {
    NSString *query = [NSString stringWithFormat:@"delete from %@", TBL_ORDERDETAIL];
    
    sqlite3_exec([DBManager sharedManager], [query UTF8String], NULL, NULL, NULL);
}

+ (BOOL) deleteWhere:(NSInteger)uid {
    NSString *query = [NSString stringWithFormat:@"delete from %@ where %@ = %ld", TBL_ORDERDETAIL, FLD_ORDERNUM, (long)uid];
...
+ (NSMutableArray*) getAllOrderDetails {
    ...
    NSString * query = [NSString stringWithFormat:@"select * from %@", TBL_ORDERDETAIL];
    ...
    id data = [OrderDetail fetch:stmt];
    while (data) {
        [list addObject:data];
        data = [OrderDetail fetch:stmt];
    }
...
+ (NSMutableArray*) getOrderDetailsWhereOrder:(OrderLine*)orderLine {
    NSMutableArray *list = [[NSMutableArray alloc] init];
    //Check for 's
...
+ (NSMutableArray*) getOrderDetailsWhereOrderNumber:(NSInteger)orderNum {
    ...
    NSString * query = [NSString stringWithFormat:@"select * from %@ where %@ = %ld", TBL_ORDERDETAIL, FLD_ORDERNUM, (long)orderNum];
