...
#define  TBL_ATTEMPTEDGMORDERHEADER @"AttemptedGMOrderHeader"
...
#define  FLD_DATEPOSTED             @"DateAttempted"
...
@interface AttemptedGMOrderHeader : NSObject
{
    NSInteger OrderNum;
    NSString * UserID;
    NSString * PONum;
